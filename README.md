この前で作ったNewGen2バージョンはデータの部分はちょっと間違えが生じてしまったから4月14日で新しいバージョンであるNewGen3を作ってmultiの機能が主に訓練しています。
今はまだ発展途上です。
お待ちください。
...
4、残差深度分離可能畳み込み構造を構築し，モデルの軽量化と特徴抽出能力を両立させる。
5、UNSW-NB15データセットにおける実験により，提案モデルが精度と効率の間で良好なバランスを達成することを検証した。
